...
def optimize_coding_aae_sensorvp(initial_condition, real_coding, epochs):
    ...
    def opt_step(initial_condition, real_coding):
        with tf.GradientTape() as tape:
            ...
            real_coding_sensor = tf.reshape(real_coding, (1, input_timestamps, ncoeffs, 1))[:,:,120:, :]
            gen_output_sensor = gen_output[:,:,120:, :]
...
np.save(root_path + 'Cotrace_fixed_720_cases/caseALL_control/aae_control_nprediction_caseALL_case8.npy', X_predict_all_list)
np.save(root_path + 'Cotrace_fixed_720_cases/caseALL_control/aae_control_4dvar_caseALL_case8.npy', X_predict_4dVar_all_list)